...
# My camping location      # ← just added
LATITUDE = 30.740432
LONGITUDE = -98.365439
LOCATION_NAME = "Inks Lake State Park"
...
# current temperature at the moment the script runs, not daily data
