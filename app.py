...
st.divider()                                   # ← just added
st.subheader("Alert Thresholds")              # ← just added
tcol1, tcol2 = st.columns(2)                  # ← just added
hot = tcol1.slider("Hot alert (F)", min_value=60, max_value=110, value=80)   # ← just added
cold = tcol2.slider("Cold alert (F)", min_value=20, max_value=65, value=45)  # ← just added
